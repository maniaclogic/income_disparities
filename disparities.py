...
df_inc = df_inc.rename(columns={'level_0': 'country', 'level_1': 'year'}).set_index('country')
...
df2 = df2.rename(columns={'level_0': 'country', 'level_1': 'year'}).set_index('country')
df2 = df2[df2['count billionaires'] != 0]
df2['average age billionaires'] = [int(i) for i in df2['average age billionaires']]

GD = gini.transpose().dropna(axis=1,how='all')
